...
This project generates mock payroll-related datasets for a multi-industry Australian business. The data includes employee details, bonuses, allowances, time off in lieu, and history records, while maintaining data integrity and realistic relationships.
